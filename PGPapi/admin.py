...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email','password', 'is_admin')
...
class formDataAdmin(admin.ModelAdmin):
    list_display = ['id','loggedPerson','date','typeOfWork','numberOfPerson','startTime','endTime','location',
                    ...
                    'newFlag', 'oldFlag', 'tocloseFlag', 'completedFlag','verified_by_person1','closedByPerson1','verified_by_person2','closedByLoggedUser','created_at',
                    ]
